        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form id="portfolio_form" action="{{route('portfolio-update')}}"
                              method="post"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="project_description" class="form-control"
                                          rows="4" id="summernote" style="display: none;
                                          ">{{$data->description}}</textarea>
                                <small style="color: #e20000" class="error" id="project_description-error"></small>
                            ...
                            <div class="form-group" style="max-width: 150px">
                                <small style="color: #e20000" class="error" id="image-error"></small>
                                <img id="show_image" class="img-fluid mb-3" src="{{!empty($data->image) ? url
                                ('uploads/images/portfolio/' . $data->image) : null}}"
                                     style="width:100%">
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $('#portfolio_form').on('submit', function(event){
                ...
                $('#portfolio_form *').filter(':input.is-invalid').each(function(){
                    this.classList.remove('is-invalid');
                });
                $('#portfolio_form *').filter('.error').each(function(){
                    this.innerHTML = '';
                });
                $.ajax({
