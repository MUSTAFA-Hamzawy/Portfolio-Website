@php use App\Models\homeBannerModel; @endphp
@php
        ...
        <div class="row align-items-center justify-content-center justify-content-lg-between">
            <div class="col-lg-6 order-0 order-lg-2">
                <div class="banner__img text-center text-xxl-end">
                    <img src="{{url('uploads/images/home_banner/' . $data->banner_image)}}" alt="">
                </div>
            </div>
            <div class="col-xl-5 col-lg-6">
                <div class="banner__content">
                    <h2 class="title wow fadeInUp" data-wow-delay=".2s"><span>{{$data->title}}</h2>
                    <p class="wow fadeInUp" data-wow-delay=".4s">{{$data->bio_description}}</p>
