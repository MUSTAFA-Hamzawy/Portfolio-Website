            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="menu__wrap">
                        <nav class="menu__nav">
                            <div class="logo">
                                <a href="index.html" class="logo__black"><img src="{{asset('frontend')
                                }}/assets/img/logo/logo_black
                                .png"
                                                                              alt=""></a>
                                <a href="index.html" class="logo__white"><img src="{{asset('frontend')
                                }}/assets/img/logo/logo_white
                                .png"
                                                                              alt=""></a>
                            </div>
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    ...
                                    <li class="active menu-item-has-children"><a href="#">Our Blog</a>
                                        <ul class="sub-menu">
                ...
                <div class="col-lg-8">
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <a href="blog-details.html"><img src="{{asset('frontend')}}/assets/img/blog/blog_thumb01
                            .jpg"
                                                             alt=""></a>
                        ...
                        <div class="standard__blog__content">
                            <div class="blog__post__avatar">
                                <div class="thumb"><img src="{{asset('frontend')}}/assets/img/blog/blog_avatar.png"
                                                        alt=""></div>
                    ...
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <a href="blog-details.html"><img src="{{asset('frontend')}}/assets/img/blog/blog_thumb02
                            .jpg"
                                                             alt=""></a>
                            <a href="blog-details.html" class="blog__link"><i class="far fa-long-arrow-right"></i></a>
                        </div>
                    ...
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <a href="blog-details.html"><img src="{{asset('frontend')}}/assets/img/blog/blog_thumb03
                            .jpg"
                                                             alt=""></a>
                            <a href="blog-details.html" class="blog__link"><i class="far fa-long-arrow-right"></i></a>
                        </div>
                    ...
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <a href="blog-details.html"><img src="{{asset('frontend')}}/assets/img/blog/blog_thumb04
                            .jpg"
                                                             alt=""></a>
                            <a href="blog-details.html" class="blog__link"><i class="far fa-long-arrow-right"></i></a>
                        </div>
                            ...
                            <ul class="rc__post">
                                <li class="rc__post__item">
                                    <div class="rc__post__thumb">
                                        <a href="blog-details.html"><img src="{{asset('frontend')
                                        }}/assets/img/blog/rc_thumb01.jpg"
                                                                         alt=""></a>
                                    </div>
                                ...
                                <li class="rc__post__item">
                                    <div class="rc__post__thumb">
                                        <a href="blog-details.html"><img src="{{asset('frontend')
                                        }}/assets/img/blog/rc_thumb02.jpg"
                                                                         alt=""></a>
                                    </div>
                                    <div class="rc__post__content">
                                ...
                                <li class="rc__post__item">
                                    <div class="rc__post__thumb">
                                        <a href="blog-details.html"><img src="{{asset('frontend')
                                        }}/assets/img/blog/rc_thumb03.jpg"
                                                                         alt=""></a>
                                    </div>
                                    <div class="rc__post__content">
                                ...
                                <li class="rc__post__item">
                                    <div class="rc__post__thumb">
                                        <a href="blog-details.html"><img src="{{asset('frontend')
                                        }}/assets/img/blog/rc_thumb04.jpg"
                                                                         alt=""></a>
                                    </div>
                                    <div class="rc__post__content">
                                ...
                                <li class="rc__post__item">
                                    <div class="rc__post__thumb">
                                        <a href="blog-details.html"><img src="{{asset('frontend')
                                        }}/assets/img/blog/rc_thumb05.jpg"
                                                                         alt=""></a>
                                    </div>
                                    <div class="rc__post__content">
