...
@section('page-title', 'Rasalina - Contact')
...
@section('content')
    ...
    <div class="contact-area">
        <div class="container">
            <form action="{{route('contact-create')}}" class="contact__form" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <input name="sender_name" type="text" placeholder="Enter your name*">
                    </div>
                    <div class="col-md-6">
                        <input name="sender_email" type="email" placeholder="Enter your mail*">
                    </div>
                    <div class="col-md-6">
